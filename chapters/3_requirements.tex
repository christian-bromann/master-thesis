...
The referred tool of this thesis, as outlined in chapter \ref{sec:scope} and more detailed descriped
in the concept section, will be a piece of software seperated into two components.
...
HbbTV Driver} will based on that component and should enable to run automated tests based on
the WebDriver protocol for arbitrary HbbTV applications on arbitrary SmartTVs. Both components
should be easy to use and integrate into a common and familar development setup of web engineers.
...
To capture network data the component should be able to act as a HTTP proxy. Used in this
...
Even though you can instrument any webpage running in any kind of web environment the DevTools
