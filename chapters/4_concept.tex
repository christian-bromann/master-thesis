...
\begin{figure}[htb]
  \centering
  \includegraphics[width=15cm]{appium-driver-diagram.png}\\
...
endpoints to identify the user and execute the session to the right device.
...
otherwise the test script would not be able to send the next one.
